/**
 * collectEventBindings — список подписок без дублей для проброса событий ядра наружу.
 *
 * Проброс у каждого адаптера свой: emit во Vue, колбэк-проп в React,
 * EventEmitter в Angular.
 *
...
import type { IEventBinding } from './types'
