 ...
 *
 * Каждое правило записано один раз: `sameValue` — и правило равенства ячеек
 * состояния, и сверка перед записью в линии; `busOf` — единственное место,
 * которое знает, где у владельца шина.
 */
