 ...
 *
 * Диагностика неверного слота (панель внутри `[role="tablist"]`) сюда не
 * входит — это работа с DOM-узлом, а расширение адаптера её не делает,
 * см. `TTabsContentWarnPlugin` (`@soldy/plugins`).
 */
