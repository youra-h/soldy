 ...
 * значения и память о том, какие пропсы фреймворк задал, — по ней снятый проп
 * отличается от непереданного. Адаптеру остаётся сказать, куда писать значение
 * и как отдать событие, и решить, в какой момент своего цикла это делать.
 */
export interface IComponentBinding {
	 ...
	 * значении, замкнул бы цикл через колбэки событий.
	 */
	 ...
	 * Дельта в `writeAll` сбросила бы к умолчанию всё, чего в ней нет.
	 */
