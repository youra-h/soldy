...
export { ButtonDescriptor, type TButtonSlots } from './button.descriptor'
...
export { ComponentViewDescriptor, type TComponentViewSlots } from './component-view.descriptor'
