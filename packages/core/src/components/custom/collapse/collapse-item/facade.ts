 ...
 */
export class TCollapseItemCollectionFacade extends TCollectionItemComponent<ICollapseItem, TCollapseCollectionExtensions> {
	protected _relayAdapters(): void {
		...
		this.events.relay(this._context.adapters.collapse.events, [{ from: 'change:view', as: 'change:collapse_view' }])
	}
