 ...
 * пишет любой слой (`TLayer`), и Frame, и окно.
 */
...
/**
 * Чем пользователь закрывает слой: кнопкой закрытия, нажатием мимо или
 * Escape.
 *
 ...
 */
export type TCloseReason = 'button' | 'outside' | 'escape'
