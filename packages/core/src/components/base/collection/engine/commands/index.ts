export type { ICommand, ICommandContext, IQueryCommand } from './types'
...
export { TPatchCommand } from './patch-command.class'
export { TQueryCommand } from './query-command.class'
