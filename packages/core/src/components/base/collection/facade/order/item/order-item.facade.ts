 ...
 *
 * Порядок есть у всех элементов (Accordion, ListBox, Select, Tabs, Tags,
 * RadioGroup), поэтому это самая нижняя item-база. Дальше ветвится: выбор — у
 * Accordion, ListBox, Select и Tags, активность — у таба и радио.
 *
