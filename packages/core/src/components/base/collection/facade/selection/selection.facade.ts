 ...
 *
 * Подключают Accordion, ListBox, Select и Tags. У Tabs выбора нет — там
 * активация, и он наследует только `TBatchCollectionFacade`. Это и есть
 * правило иерархии: фасады повторяют **состав расширений**, а не таксономию
 * компонентов, и сужение дженерика делает нарушение ошибкой компиляции.
 *
