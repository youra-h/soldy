 ...
 *
 * Подключают Accordion, ListBox, Select и Tags. У Tabs и RadioGroup выбора
 * нет — там активация, и они наследуют соседнюю базу
 * `TActivationCollectionFacade`. Это и есть правило иерархии: фасады
 * повторяют **состав расширений**, а не таксономию компонентов, и сужение
 * дженерика делает нарушение ошибкой компиляции.
 *
