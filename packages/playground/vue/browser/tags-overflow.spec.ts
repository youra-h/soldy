 ...
 * сторона кольца: его рисует пилюля. До всей пилюли ряд докручивает плагин
 * клавиатуры, а запас под кольцо у края — `scroll-padding` области.
 *
...
describe('режим arrows: ряд листают кнопки', () => {
	 ...
	 * нём. Докрутке плагина клавиатуры после него делать нечего, и тесты
	 * сторожат, что вдвоём со снапом ленты они тег за край не уводят.
	 */
