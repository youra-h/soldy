 ...
 *
 * Стрелки набора с выбором докручивает до тега и плагин клавиатуры
 * (`TTagsKeyboardPlugin`, `scrollIntoView` с `nearest`) — до того же окна:
 * `scroll-padding` соблюдает и браузер. Зовёт он её после `focus()`, то есть
 * после этого плагина, и тег в окне застаёт уже на месте.
 *
