...
/**
 * Типы выходов Control для строгой проверки шаблона: эмиттеры ставит
 * `TComponentBase` по `ControlOutputs`, поля их только объявляют.
 */
@Directive({ standalone: true })
export abstract class TControlOutputs<TInstance extends IEntity> extends TComponentBase<TInstance> {
