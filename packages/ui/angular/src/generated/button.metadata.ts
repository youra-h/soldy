...
/**
 * Типы выходов Button для строгой проверки шаблона: эмиттеры ставит
 * `TComponentBase` по `ButtonOutputs`, поля их только объявляют.
 */
@Directive({ standalone: true })
export abstract class TButtonOutputs<TInstance extends IEntity> extends TComponentBase<TInstance> {
