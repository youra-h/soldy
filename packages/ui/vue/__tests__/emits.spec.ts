 ...
 * выходам связки `bindComponent`, куда входят и плагинные. Проп при этом был
 * объявлен: `useProps` строится по поверхности `surfaceOf`, а та собрана из
 * `getProps()`. То есть проп принимался, но его обратная связь считалась
 * незадекларированной.
 *
