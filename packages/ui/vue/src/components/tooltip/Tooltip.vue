...
<template>
	...
	>
		...
		<!--
			Панель — Frame: телепорт, слой, привязка к корню — над триггером
			от его начала, в 6 px от него — и пометка владельцем, по которой
			панель находят плагины. На неё ложится `aria` подсказки:
