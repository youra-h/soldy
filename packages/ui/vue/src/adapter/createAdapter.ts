...
import type { TComponentAccessor, INamingStrategy, IComponentSchema, ICompiledProp, IContextElevator } from '@soldy/accessor'
...
export function createVueAdapter(naming: INamingStrategy = vueNaming) {
    ...
    function useAdapter(
        ...
        const parentCollection = parentContexts['collection'] as { insertAt(item: any, index?: number): boolean; deleteItem(item: any): boolean } | undefined
