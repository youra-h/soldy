...
Одной теме нужны пять видов кнопки и ни одного варианта, другой — ни одного
...
класс строкой. Пропсы React, Solid и Svelte, шаблоны Vue и стенд выводятся из
пропсов ядра и получают имена темы сами.
...
Плагины значений темы тоже не читают: `TTabsViewPlugin` пишет геометрию
активного таба для любого вида, а какая нужна виду, решает тема.
